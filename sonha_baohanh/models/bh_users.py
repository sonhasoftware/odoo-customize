...
class BHUsers(models.Model):
    ...
    description = fields.Char(string="Tên người dùng")
    password = fields.Char(string="Mật khẩu")
    password_hint = fields.Text(string="PasswordHint")
    phone_number = fields.Char(string="Di động")
    ...
    #     string="Chi nhánh"
    # )
    position = fields.Selection([('user', "Người dùng"), ('employee', "Nhân viên")], string="Vị trí")
