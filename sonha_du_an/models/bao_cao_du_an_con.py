...
class BaoCaoDuAnCon(models.Model):
    _name = 'sonha.du.an.bao.cao.con'
    ...
    du_an_cha = fields.Many2one('sonha.du.an.bao.cao.con', string="Dự án cha", index=True, store=True, ondelete='set null',)
    du_an_con = fields.Many2one('sonha.du.an.bao.cao.con', string="Dự án con", index=True, store=True, ondelete='set null',)
    ...
    def action_open_generate_wizard(self):
        return {
            ...
            'res_model': 'sonha.du.an.con.bao.cao.wizard',
            'view_mode': 'form',
            'target': 'new',
        }