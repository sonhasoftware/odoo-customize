...
class SonHaKPIResultMonth(models.Model):
    ...
    diem_dat_dv_amount_work = fields.Float("Điểm đạt ĐVĐG (khối lượng CVTH)")
    diem_dat_dv_matter_work = fields.Float("Điểm đạt ĐVĐG (Chất lượng CVTH)")
    diem_dat_dv_comply_regulations = fields.Float("Điểm đạt ĐVĐG (Chấp hành nội quy, quy chế)")
    diem_dat_dv_initiative = fields.Float("Điểm đạt ĐVĐG (Cải tiến, đề xuất, sáng kiến)")

    quy_doi_dv_amount_work = fields.Float("Điểm quy đổi theo tỉ trọng ĐVĐG (khối lượng CVTH)")
    quy_doi_dv_matter_work = fields.Float("Điểm quy đổi theo tỉ trọng ĐVĐG (Chất lượng CVTH)")
    quy_doi_dv_comply_regulations = fields.Float("Điểm quy đổi theo tỉ trọng ĐVĐG (Chấp hành nội quy, quy chế)")
    quy_doi_dv_initiative = fields.Float("Điểm quy đổi theo tỉ trọng ĐVĐG (Cải tiến, đề xuất, sáng kiến)")
    ...
    diem_dat_tq_amount_work = fields.Float("Điểm đạt ĐVTQ (khối lượng CVTH)")
    diem_dat_tq_matter_work = fields.Float("Điểm đạt ĐVTQ (Chất lượng CVTH)")
    diem_dat_tq_comply_regulations = fields.Float("Điểm đạt ĐVTQ (Chấp hành nội quy, quy chế)")
    diem_dat_tq_initiative = fields.Float("Điểm đạt ĐVTQ (Cải tiến, đề xuất, sáng kiến)")

    quy_doi_tq_amount_work = fields.Float("Điểm quy đổi theo tỉ trọng ĐVTQ (khối lượng CVTH)")
    quy_doi_tq_matter_work = fields.Float("Điểm quy đổi theo tỉ trọng ĐVTQ (Chất lượng CVTH)")
    quy_doi_tq_comply_regulations = fields.Float("Điểm quy đổi theo tỉ trọng ĐVTQ (Chấp hành nội quy, quy chế)")
    ...
    dv_do_luong = fields.Char("Chỉ tiêu đo lường", compute="get_dv_do_luong")
