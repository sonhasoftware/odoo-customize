    ...
    def action_export(self):
        ...
        for record in list_record:
            ...
            if self.report.key == "tdkl":
                ...
                sheet.cell(row=row, column=8).value = str(record.date_sign) or ''
                sheet.cell(row=row, column=9).value = str(record.date_start) or ''
                sheet.cell(row=row, column=10).value = record.form_discipline.name or ''
                sheet.cell(row=row, column=11).value = str(record.date_end) or ''
            ...
            # Báo cáo theo dõi khen thưởng
                ...
                sheet.cell(row=row, column=8).value = str(record.sign_date) or ''
                sheet.cell(row=row, column=9).value = str(record.effective_date) or ''
        ...
        if self.report.key == "thklbt":
            ...
            for department in list_department:
                count_emp_discipline = len(list_department.filtered(lambda x: x.id == department.id))
