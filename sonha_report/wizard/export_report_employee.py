    ...
    def action_export(self):
        ...
        for record in list_record:
            if self.report.key == "bdns":
                ...
                sheet.cell(row=row, column=20).value = record.gender or ''
                ...
                sheet.cell(row=row, column=5).value = record.gender or ''
                sheet.cell(row=row, column=6).value = record.marital_status or ''
                sheet.cell(row=row, column=7).value = record.nation or ''
                sheet.cell(row=row, column=8).value = record.religion or ''
                ...
                sheet.cell(row=row, column=26).value = ''
                sheet.cell(row=row, column=27).value = str(record.date_quit) or ''
